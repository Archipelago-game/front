...
const largeFontSize = { fontSize: "1.1em" };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Button sx={largeFontSize} variant="text" onClick={addCharacter}>
            Создать нового героя
          </Button>

          {addCharacterConstructor && (
            <Button sx={largeFontSize} onClick={addCharacterConstructor}>
              Создать персонажа через конструктор
            </Button>
          )}

          <Button sx={largeFontSize} component="label">
            Загрузить героя
            <Input
              type="file"
              sx={{ display: "none" }}
