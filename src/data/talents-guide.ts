...
export const talentsGuide: TalentGuideType[] = [
  ...
  },
  {
    ...
    name: "Невозмутимость",
    description:
      "Когда персонаж заявляет реакцию защиты от ментальной атаки, он может вместо того, чтобы проходить проверку против атаки противника, получить количество отваги равное его К.У. на атаку, считая бонус ментального урона, для которой работает талант “Открытая Ладонь”",
    rang: 1,
    focus: 3,
  },
  {
    ...
    description:
      "Персонаж может добавить к своим атакам “Открытой Ладонью” не только бонус физического, но и бонус ментального урона. В т.ч., для талантов “Несокрушимость” и “Невозмутимость”. Так же, при успешной атаке можно потратить 2 моментума, чтобы перевести весь урон в ментальный.",
    rang: 1,
    focus: 4,
  },
  {
    ...
    name: "Продолжение",
    description:
      "Выберите один вид оружия ближнего боя. Теперь для этого оружия работает талант “Открытая Ладонь” и все с ним связанные. Ранг позволяет получить второе такое оружие.",
    rang: 2,
    focus: 2,
  },
  {
  ...
  },
  {
    ...
    name: "Море по колено",
    description:
      "Вне Сцены Действия, успешно пройдя проверку Сопротивления равную количеству ран, персонаж может немедленно закрыть их, если получил их будучи пьяным. За каждый сгенерированный именно этой проверкой моментум, он может немедленно списать одну рану. Проверку можно повторить только после получения новых ран.",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    name: "Кусь Смерти",
    description:
      "После успешного применения “Глаз Хищинка” атака зубами автоматически попадает в голову, и получает свойство “Изнуряющая”.",
    rang: 1,
    focus: 3,
  },
  {
  ...
  },
  {
    ...
    description:
      "Если вы можете в прыжке коснуться ногой хоть чего-нибудь, хотя бы листика - вы можете немедленно совершить ещё один прыжок, но проверка будет от Воли. (Воля + Акробатика).",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    description:
      "При выпадении усложнения на проверке воровства можно перебросить весь пул кубов, и добавить успехи и усложнения к результату проверки. Продолжать пока не перестанут выпадать усложнения.",
    rang: 1,
    focus: 1,
  },
  {
    branch: "Воровство (Подвижность)",
    name: "Взломщик",
    description:
      "Позволяет пройти проверку воровства вместо ремесла, чтобы создать набор взломщика. Это ящик с отмычками, фомками и прочим. Можно иметь при себе один. Отмычки добавляют ранг таланта к проверке взлома, и их можно использовать количество раз, равное количеству успехов. Сбор такого набора занимает несколько часов, и требует доступа к магазинам или ремесленникам.",
    rang: 3,
    focus: 2,
  },
  {
    ...
    name: "Форточник",
    description:
      "В случае, если нужно забраться на высоту, вылезти в окно и прочие варианты \"скалолазания\" для совершения кражи, можно заменить акробатику на воровство.",
    rang: 1,
    focus: 2,
  },
  {
    ...
    description:
      "Выходя на дело, вы привыкли быть неприметным и передвигаться скрытно. Можете заменить проверку скрытности на воровство в городских условиях, или внутри зданий/построек.",
    rang: 1,
    focus: 2,
  },
  {
    branch: "Воровство (Чувства)",
    name: "Мошенник",
    description: "В случае, если вы мошенничаете, вы можете заменить манипуляцию на воровство.",
    rang: 1,
    focus: 2,
  },
  {
    ...
    name: "Шулер",
    description:
      "Вы провели много времени за карточным столом и умеете читать своих противников и чувствовать малейшие изменения в картах. Можно заменить проверки Чувств (Осязание) и Понимания на воровство, когда дело касается азартных игр.",
    rang: 1,
    focus: 2,
  },
  {
    ...
    name: "Мафиозный Босс",
    description:
      "Вам знакома организация преступного мира, и вы в неё встроены. Мы можете заменить проверку командования на воровство, когда имеете дело с другими представителями преступного мира, а также когда занимаетесь созданием собственной преступной организации.",
    rang: 1,
    focus: 2,
  },
  {
    branch: "Воровство",
    name: "Кристальная Жизнь",
    description:
      "Вы считаетесь обладателем всех талантов из Воровства, независимо от поля экспертизы, но вы обязаны придерживаться кристальной жизни:  Не браться ни за какую честную работу.  Не носить никаких украшений, кроме татуировки.   Не сотрудничать с властями.   Не иметь семьи.  Не заниматься политикой.  Если правила нарушены, то вы остаётесь обладателем только приобретенных до этого талантов. Чтобы восстановить \"воровскую честь\" надо совершить какое-то особо выдающееся преступление.",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    name: "Не Упал",
    description:
      "Вы можете потратить одно или несколько очков удачи, чтобы немедленно закрыть (и списать) равное количество ран. Вы лишаетесь возможности восстанавливать удачу на такое же количество сессий (отсчёт ведётся от сессии, где талант был применён). Либо, вы можете потратить одно очко решимости, чтобы закрыть (и списать) все открытые раны. Можно применять в момент получения раны.",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    description:
      "Перед каждым выстрелом вы можете пройти проверку Артиллерии от Интеллекта 2У, чтобы снизить сложность попадания на 1У, до минимума в 0У. Эффект суммируется до ранга таланта. Вы должны лично находиться за орудием. Неуспех на проверке знания автоматически проваливает проверку стрельбы. Промах сбрасывает накопленный эффект.",
    rang: 2,
    focus: 2,
  },
  {
  ...
  },
  {
    ...
    name: "Студент",
    description:
      "Вы получали или до сих пор получаете формальное образование. У вас есть большое количество конспектов и записей с вашей учёбы, с которыми вы можете сверяться. Если вы попадает в фокус, вы можете задать равное фокусу количество дополнительных вопросов.",
    rang: 1,
    focus: 1,
  },
  {
  ...
  },
  {
    ...
    name: "Юрисприденция",
    description:
      "Ранг 1: Вы неплохо поднаторели в чтении формальных договоров. Когда вы читаете договоры, и прочие формальные документы, вы можете пройти проверку Цивилизации сложность 2У чтобы выявить любые недочеты, ошибки, и уловки. В случае, если составитель договора владел вторым рангом этого таланта, сложность проверки задаётся его броском. Ранг 2: Вы умеете составлять договоры, формальные документы, и в целом для вас язык юридического документа и канцелярии стал как родной. Когда вы составляете договор, пройдите проверку Цивилизации. Вы можете добавить выгодное вам условие. Всего можно добавить количество условий, равное вашему фокусу в Цивилизации. Чтобы оспорить эти условия, читающий договор должен перебросить вашу проверку Цивилизации своей. Если он владеет первым рангом этого таланта, то сравнять успехи.",
    rang: 2,
    focus: 2,
  },
  {
    ...
    name: "Протестую!",
    description:
      "Вы умеете резонно и по существу возразить, ссылаясь на своё знание законов и традиций Архипелага. Когда вам нужно сопротивляться эффектам Социальных Интеракций, заплатите мастеру 1 рок, чтобы использовать Цивилизацию, в качестве встречной проверки против Убеждения или Манипуляции. Такое применение не сработает, если вы абсолютно не знакомы с законами или традициями тех, с кем имеете дело, или если таковых у них вовсе нет.",
    rang: 1,
    focus: 3,
  },
  {
    ...
    name: "Я - Закон",
    description:
      "Вы можете написать Законодательный Акт, который вносит значительные изменения в социальное и\\или экономическое устройство. Обладая этим талантом вы можете обсудить с Мастером создание юридического документа, изменяющего социальное и\\или экономическое положение в масштабах страны. Ориентирами могут служить знаковые документы, как то “Билль о правах”, “Декларация Прав Человека”, “Манифест Коммунизма” и т.д.. Они должны быть потенциально работоспособными, не уходить слишком далеко от уровня развития Архипелага (идеи не прогрессивнее первой половины XIX века в нашем мире). Пройдите проверку Цивилизации сложностью 0У. Вычтите из 5 выпавшее количество успехов. Это будет сложность защитить/протащить ваш закон. Защита закона требует нарративного отыгрыша. За каждое усложнение потребуется пройти дополнительную инстанцию в принятии закона. Даже если успехов не было, или результат вас не устраивает - процесс защиты закона необходимо пройти. Если закон не был успешно защищен это вызывает сильную реакцию властей, и вы попадает в опалу вплоть до политического преследования как угрозу власти и обществу.",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    description:
      "Этот талант можно получить либо нарративно, либо на пятом уровне фокуса в медицине. Вы можете применять навык медицины для закрытия ментальных травм. Сложно повышается на 1У.",
    rang: 1,
    focus: 5,
  },
  {
  ...
  },
  {
    ...
    name: "Неуязвимый",
    description:
      "Если в бою (сцене действия) вы получили рану, то вы можете нанести противникам, которые это видели, 6+Бонус Менального Урона К.У. отчаяния, со свойством оглушение (Бросок командования, защищаться дисциплиной). Применять один раз за рану, и в момент получения новой раны (то есть, если вы получили три раны за раз - применять один раз. Если вы получили рану, и открылось ещё две - применять один раз. Если вы получили три раны за бой по очереди - применять три раза). Союзники, которые это видели, получают +1 К.У. Морали и +1 К.У. укрытия на время сцены. Если вас убили на глазах у союзников, они теряют накопленный позитивный эффект, а также получают урон от негативного (можно пройти проверку дисциплины 3У, чтобы этого избежать).",
    rang: 1,
    focus: 4,
  },
  {
  ...
  },
  {
    ...
    name: "Как Книгу",
    description:
      "Если вы дошли до бонуса “Обмани меня” +2: Пройдите проверку Понимания от Воли сложностью 1У. Вы раскрываете количество успехов + потраченные моментумы аспектов его личности. Точные значения ментальных атрибутов, точное количество решимости, удачи, ментального здоровья, ценность, и даже его природу. Это сбросит “Обмани Меня”.",
    rang: 1,
    focus: 4,
  },
  {
